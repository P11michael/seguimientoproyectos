        ...
        <header style="height: 30px;">
            ...
            <div class=" d-flex justify-content-between align-items-center">
                <div class="col-6 pt-1">
                    <a class="footer0">Sistema de Seguimiento de Hojas de Ruta</a>
                </div>
                <div class="col-6 d-flex justify-content-end align-items-center">
                <a class="footer0"><?php date_default_timezone_set("America/La_Paz"); echo date('d/m/Y');?></a>
                    <a class="footer0"> | </a>
                    <a class="footer0" style="text-transform: uppercase;"> <?php echo $_SESSION['usuarioFunc'];?></a> 
                </div>
            </div>
            </div>
        </header>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        <div class="navbar-nav">
                            ...
                            <li class="<?php echo $pagina == 'listaSolicitudServicios' ? 'active' : ''; ?>"><a class="nav-item nav-link" href="?p=listaSolicitudServicios">Buzón de entrada</a></li>
                            <li class="<?php echo $pagina == 'registro_s_servicio' ? 'active' : ''; ?>"><a class="nav-item nav-link" href="?p=registro_s_servicio">Registrar reformulado</a></li>
                            <li class="<?php echo $pagina == 'registro_proyecto' ? 'active' : ''; ?>"><a class="nav-item nav-link" href="?p=registro_proyecto">Registrar proyecto</a></li>
