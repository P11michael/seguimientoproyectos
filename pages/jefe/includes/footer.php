<footer class="container-fluid text-center footer-guest">
            ...
            <div class="container col-xs- col-sm- col-md-12 col-log-">
                            <div class="text-center">
                                <h6 class="d-inline-block">Contacto: sistemas_gamcol@colcapirhua.gob.bo , gamc@colcapirhua.gob.bo</a></h6>
    ...
    <script src="../../bootstrap/validacion/form-validation.js"></script>
    ...
    <script> ajustarFooter(); </script>
    <script src="../../librerias/js/popper.min.js"></script>
    <script type="text/javascript" src="../../librerias/datatables/datatables.min.js"></script>    
    <script type="text/javascript" src="../../controlador/crud.js"></script> 
    </body>
</html>